...
/**
 * 
 * 用法String tbl_name = Inflector.getInstance().tableize(ForumPost.class);
 * Transforms words (from singular to plural, from camelCase to under_score, etc.). 
 * I got bored of doing Real Work...
 */
public class Inflector {

    // Pfft, can't think of a better name, 
	// but this is needed to avoid the price of initializing the pattern on each call.
