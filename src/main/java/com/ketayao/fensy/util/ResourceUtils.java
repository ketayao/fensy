...
public class ResourceUtils {
    ...
    public static ResourceBundle getResourceBundle(Locale locale, String baseName) {
    ...
    private static String _getStringForLocale(Locale locale, String baseName, String key) {
        try {
            ResourceBundle rb = getResourceBundle(locale, baseName);
     ...
     * @return
     */
    public static String getStringForLocale(Locale locale, String baseName, String key,
                                            Object... args) {
